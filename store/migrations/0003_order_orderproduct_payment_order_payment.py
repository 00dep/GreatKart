    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('Stripe', 'Stripe'), ('UPI', 'UPI'), ('COD', 'Cash on Delivery')], default='COD', max_length=20)),
                ('payment_gateway_id', models.CharField(blank=True, max_length=250)),
